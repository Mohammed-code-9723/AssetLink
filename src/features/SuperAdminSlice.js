...
export const workspacesData = createAsyncThunk('workspaces/workspacesData', async (token) => {
    ...
    `${process.env.REACT_APP_API_URL}/api/workspaces/allWorkspaces`
    :
...
export const sitesData = createAsyncThunk('sites/sitesData', async ({token,value}) => {
    const user=JSON.parse(localStorage.getItem('user'));
    const url=(user?.role==='superadmin'||user?.role==='admin'||user?.role==='manager')?
    `${process.env.REACT_APP_API_URL}/api/workspaces/allSites`
    :
    `${process.env.REACT_APP_API_URL}/api/workspaces/${value}/sites`;
...
export const buildingsData = createAsyncThunk('buildings/buildingsData', async (token) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_API_URL}/api/workspaces/allBuildings`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
export const projectsData = createAsyncThunk('projects/projectsData', async (token) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_API_URL}/api/workspaces/allProjects`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
export const deleteUser = createAsyncThunk('delUser/deleteUser', async ({ token, id }) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/users/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
...
export const updateUser = createAsyncThunk('updateUser/updateUser',async ({ token, updateUserState }) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/update_user`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`,
...
export const updateUsersPermissions = createAsyncThunk(
    ...
    async ({updatedUsers,  token }) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/update_permissions`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}` 
...
export const activitiesData = createAsyncThunk('activities/activitiesData', async (token) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/activities`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
export const deleteWorkspace = createAsyncThunk('delWorkspace/deleteWorkspace', async ({ token, id }) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/workspaces/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
...
export const deleteSite = createAsyncThunk('delSite/deleteSite', async ({ token, id }) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/sites/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
...
export const addSiteAsync = createAsyncThunk('newSite/addSiteAsync', async ({ token, newSite,workspace }) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/${workspace}/addSite`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
...
export const updateSite = createAsyncThunk(
    ...
    async ({updatedSite,  token }) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/update_site`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}` 
...
export const componentsData = createAsyncThunk('components/componentsData', async ({token,building_id,workspace_id,site_id}) => {
    ...
    const user=JSON.parse(localStorage.getItem('user'));
    const url=(user?.role==='superadmin'||user?.role==='admin'||user?.role==='manager')?
    `${process.env.REACT_APP_API_URL}/api/auth/Components`
    :
    `${process.env.REACT_APP_API_URL}/api/workspaces/${workspace_id}/sites/${site_id}/buildings/${building_id}/components`;
...
export const incidentsData = createAsyncThunk('incidents/incidentsData', async (token) => {
    ...
    const url=(user?.role==='superadmin'||user?.role==='admin'||user?.role==='manager')?(
        `${process.env.REACT_APP_API_URL}/api/auth/allIncidents`
    ):(
        `${process.env.REACT_APP_API_URL}/api/workspaces/usersIncidents`
    )
    const response = await fetch(url, {
        method: 'GET',
        headers: {
